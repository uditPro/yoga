    ...
    <main className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden lotus-pattern">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          {/* Floating Lotus Icon */}
          <div className="mb-6 sm:mb-8 inline-block animate-lotus-bloom">
            <span className="text-5xl sm:text-7xl md:text-8xl drop-shadow-2xl">🪷</span>
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-bold mb-4 sm:mb-6 animate-fade-in-up">
            <span className="gradient-text" style={{ fontFamily: 'var(--font-playfair)' }}>
              Transform Your
            </span>
          </h1>
          
          <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 sm:mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <span className="gradient-text" style={{ fontFamily: 'var(--font-playfair)' }}>
              Body • Mind • Spirit
            </span>
          </h2>

          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed animate-fade-in-up px-2" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div
                key={index}
                className="zen-card bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500"
                style={{ animationDelay: `${index * 0.2}s` }}
              >
                <div className="text-6xl mb-6 animate-float" style={{ animationDelay: `${index * 0.5}s` }}>
                  {feature.icon}
                </div>
                <h3 className="text-2xl font-bold mb-4 text-primary" style={{ fontFamily: 'var(--font-playfair)' }}>
                  {feature.title}
                </h3>
      ...
      {/* Classes Preview */}
      <section className="py-16 sm:py-24 md:py-32 lotus-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 gradient-text" style={{ fontFamily: 'var(--font-playfair)' }}>
              Our Classes
            ...
            {[
              ...
              >
                ...
                <div className="relative h-full flex flex-col items-center justify-center p-6 text-white">
                  ...
                  <span className="text-sm bg-white/30 px-4 py-1 rounded-full backdrop-blur-sm">
                    {yogaClass.level}
                  </span>
                  <div className="mt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <button className="px-6 py-2 bg-white text-gray-900 rounded-full font-bold hover:scale-110 transition-transform shadow-lg">
                      Learn More
                    </button>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div
                key={index}
                className="zen-card bg-white rounded-3xl p-8 shadow-lg"
              >
                <div className="flex mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <span key={i} className="text-2xl text-mandala-gold">⭐</span>
                  ))}
                </div>
      ...
      <section className="py-16 sm:py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 text-white drop-shadow-lg" style={{ fontFamily: 'var(--font-playfair)' }}>
            Begin Your Transformation Today
          </h2>
          
          <p className="text-base sm:text-lg md:text-xl mb-8 sm:mb-12 leading-relaxed text-white drop-shadow-md px-2">
            Join thousands who have discovered inner peace and physical vitality. 
            Your journey to wellness starts with a single breath.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center px-4">
            <button className="px-8 sm:px-10 py-4 sm:py-5 bg-white text-primary text-base sm:text-lg font-bold rounded-full hover:scale-110 transition-transform duration-300 shadow-2xl hover:shadow-3xl flex items-center justify-center space-x-2 w-full sm:w-auto">
              <span>Book Free Trial Class</span>
              <span>🎁</span>
            </button>
            <button className="px-8 sm:px-10 py-4 sm:py-5 bg-transparent border-3 border-white text-white text-base sm:text-lg font-bold rounded-full hover:bg-white hover:text-primary transition-all duration-300 hover:scale-110 w-full sm:w-auto">
              View Schedule
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-2">📧 hello@serenity.yoga</p>
